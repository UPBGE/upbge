...
.. code-block:: javascript
   ...
   const cont = bge.logic.getCurrentController() // bge.logic is automatically imported;
...
.. code-block:: javascript
   ...
   // To get a sensor linked to this cont.;
...
.. data:: joysticks
   ...
   :type: array of :class:`~bge.types.SCA_PythonJoystick`
...
.. function:: getCurrentController()
   ...
   Gets the JavaScript/TypeScript controller associated with this JavaScript/TypeScript script.
