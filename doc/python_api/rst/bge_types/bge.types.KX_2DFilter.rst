...
.. class:: KX_2DFilter(RAS_2DFilter, BL_Shader)
   ...
   .. method:: setTexture(textureName, textureBindCode, index(optional))
      ...
      index is an optional argument: each GLSL 2D Filter has 8 slots(indexes) that can be used to bind a texture with his bindcode.
      ...
      If all slots are already in use, you can choose to use index option to force the slot to be used. This will overwrite the previous
      slot with the new defined bindCode.
