...
if(WITH_AUDASPACE)
  ...
  target_include_directories(bf_deps_optional_audaspace SYSTEM INTERFACE ${AUDASPACE_C_INCLUDE_DIRS})
  if(WITH_PYTHON)
    target_include_directories(bf_deps_optional_audaspace SYSTEM INTERFACE ${AUDASPACE_PY_INCLUDE_DIRS})
  endif()
  if(WITH_SYSTEM_AUDASPACE)
    target_link_libraries(bf_deps_optional_audaspace INTERFACE ${AUDASPACE_C_LIBRARIES})
    if(WITH_PYTHON)
      target_link_libraries(bf_deps_optional_audaspace INTERFACE ${AUDASPACE_PY_LIBRARIES})
    endif()
  else()
    target_link_libraries(bf_deps_optional_audaspace INTERFACE audaspace)
    if(WITH_PYTHON)
      target_link_libraries(bf_deps_optional_audaspace INTERFACE audaspace-py)
    endif()
  endif()
endif()
