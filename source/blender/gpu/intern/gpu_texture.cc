...
void GPU_texture_bind_bge(GPUTexture *tex_, int unit)
{
  GLTexture *tex = reinterpret_cast<GLTexture *>(tex_);
  GPU_context_active_get()->state_manager->texture_bind_bge(tex, unit);
}
/********************End of Game engine**********************/
