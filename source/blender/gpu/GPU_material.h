...
GPUMaterial *GPU_material_from_eevee(struct Scene *scene, struct Material *ma, const char *vert_code, const char *frag_lib, const char *defines, bool is_instancing);
