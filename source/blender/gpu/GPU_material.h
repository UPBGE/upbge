...
typedef enum GPUDynamicType {
	...
	GPU_DYNAMIC_TEX_INTENSCOLFAC     = 1  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_COLFAC           = 2  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_ALPHAFAC         = 3  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_SPECFAC          = 4  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_COLSPECFAC       = 5  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_HARDSPECFAC      = 6  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_EMITFAC          = 7  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_MIRRORFAC        = 8  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_NORMALFAC        = 9  | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_PARALLAXBUMPFAC  = 10 | GPU_DYNAMIC_GROUP_TEX,
	GPU_DYNAMIC_TEX_PARALLAXSTEPFAC  = 11 | GPU_DYNAMIC_GROUP_TEX
} GPUDynamicType;
