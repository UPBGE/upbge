...
typedef enum GPUOffScreenMode {
	...
	GPU_OFFSCREEN_ATTACHEMENT_CUBEMAP_X_POS = 1 << 3,
	GPU_OFFSCREEN_ATTACHEMENT_CUBEMAP_X_NEG = 1 << 4,
	GPU_OFFSCREEN_ATTACHEMENT_CUBEMAP_Y_POS = 1 << 5,
	GPU_OFFSCREEN_ATTACHEMENT_CUBEMAP_Y_NEG = 1 << 6,
	GPU_OFFSCREEN_ATTACHEMENT_CUBEMAP_Z_POS = 1 << 7,
	GPU_OFFSCREEN_ATTACHEMENT_CUBEMAP_Z_NEG = 1 << 8,
} GPUOffScreenMode;
