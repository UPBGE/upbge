...
static PyObject *PyInit_gpu(void)
{
	...
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_INTENSCOLFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_COLFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_ALPHAFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_SPECFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_COLSPECFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_HARDSPECFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_EMITFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_MIRRORFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_NORMALFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_PARALLAXBUMPFAC);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_TEX_PARALLAXSTEPFAC);
