...
namespace blender::nodes::node_logic_set_action_frame_cc {
...
static void node_declare(NodeDeclarationBuilder &b)
{
  ...
  b.add_input<decl::Float>("Frame"_ustr).default_value(0.0f);
...
static void node_register()
{
  ...
  logic_node_type_base(&ntype, "LogicNativeSetActionFrame"_ustr);
