...
namespace blender::nodes::node_logic_color_rgba_cc {
...
static void node_declare(NodeDeclarationBuilder &b)
{
  ...
  b.add_input<decl::Float>("A"_ustr).default_value(1.0f).min(0.0f).max(1.0f);
...
static void node_register()
{
  ...
  logic_node_type_base(&ntype, "LogicNativeColorRGBA"_ustr);
