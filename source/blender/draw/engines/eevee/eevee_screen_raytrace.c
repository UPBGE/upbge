...
void EEVEE_screen_raytrace_cache_init(EEVEE_ViewLayerData *sldata, EEVEE_Data *vedata)
{
  ...
  if ((effects->enabled_effects & EFFECT_SSR) != 0) {
    ...
    struct GPUShader *ssgi_filter_sec_shader = EEVEE_shaders_effect_ssgi_filter_sec_sh_get();
    ...
    int gi_resolve_res[3];
    GPU_texture_get_mipmap_size(effects->ssgi_filter_input, 0, gi_resolve_res); //TODO - correct res
    GPU_texture_get_mipmap_size(effects->ssgi_filter_sec_input, 0, gi_resolve_res); //TODO - correct res
