 ...
 * option.
 */
struct DRWShadingGroup *EEVEE_default_shading_group_create_no_pass(EEVEE_Data *vedata, bool is_hair, bool is_flat_normal, bool use_blend, bool use_ssr, int shadow_method)
{
	static int ssr_id;
	ssr_id = (use_ssr) ? 0 : -1;
	int options = VAR_MAT_MESH;
