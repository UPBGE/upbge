...
DNA_STRUCT_RENAME_MEMBER(Brush, falloff_angle, falloff_angle_legacy)
...
DNA_STRUCT_RENAME_MEMBER(FCurve, rna_path, rna_path_ptr)
...
DNA_STRUCT_RENAME_MEMBER(SpaceConsole, lheight, line_height)
...
DNA_STRUCT_RENAME_MEMBER(SpaceText, lheight, line_height)
...
DNA_STRUCT_RENAME_MEMBER(UserDef, geometry_nodes_stack_limit, nodes_stack_limit)
