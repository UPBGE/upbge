...
#define SENS_JOY_LEFT_SHOULDER_TRIGGER_PRESS	0
#define SENS_JOY_RIGHT_SHOULDER_TRIGGER_PRESS	1
#define SENS_JOY_LEFT_SHOULDER_TRIGGER_RELEASE	2
#define SENS_JOY_RIGHT_SHOULDER_TRIGGER_RELEASE	3

#define SENS_JOY_LEFT_STICK			1
#define SENS_JOY_RIGHT_STICK		2
#define SENS_JOY_SHOULDER_TRIGGER	3
...
#define SENS_JOY_LEFT_SHOULDER_TRIGGER	5
#define SENS_JOY_RIGHT_SHOULDER_TRIGGER	6
