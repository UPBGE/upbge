...
wmWindow *wm_window_copy(struct bContext *C,
                         wmWindow *win_src,
                         const bool duplicate_layout,
                         const bool child);
wmWindow *wm_window_copy_test(struct bContext *C,
                              wmWindow *win_src,
                              const bool duplicate_layout,
                              const bool child);
...
void wm_window_ghostwindows_remove_invalid(struct bContext *C, wmWindowManager *wm);
...
int wm_window_new_exec(struct bContext *C, struct wmOperator *op);
