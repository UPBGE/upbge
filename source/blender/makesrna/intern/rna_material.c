...
void RNA_def_material(BlenderRNA *brna)
{
	...
	prop = RNA_def_property(srna, "use_instance", PROP_BOOLEAN, PROP_NONE);
	RNA_def_property_boolean_sdna(prop, NULL, "shade_flag", MA_INSTANCE);
	RNA_def_property_ui_text(prop, "Geometry Instancing", "Use special vertex shader for instance rendering in blender game engine");
