...
static void rna_Actuator_Armature_update(Main *UNUSED(bmain),
                                         Scene *UNUSED(scene),
                                         PointerRNA *ptr)
{
  bActuator *act = (bActuator *)ptr->data;
...
static void rna_def_constraint_actuator(BlenderRNA *brna)
{
  ...
  RNA_def_property_float_funcs(
      prop, "rna_ConstraintActuator_limitmin_get", "rna_ConstraintActuator_limitmin_set", NULL);
  ...
  RNA_def_property_float_funcs(
      prop, "rna_ConstraintActuator_limitmax_get", "rna_ConstraintActuator_limitmax_set", NULL);
  RNA_def_property_ui_range(prop, -2000.f, 2000.f, 1, 2);
  RNA_def_property_ui_text(prop, "Max", "");
  RNA_def_property_update(prop, NC_LOGIC, NULL);
  ...
  RNA_def_property_float_funcs(
      prop, "rna_ConstraintActuator_range_get", "rna_ConstraintActuator_range_set", NULL);
  ...
  RNA_def_property_float_funcs(
      prop, "rna_ConstraintActuator_distance_get", "rna_ConstraintActuator_distance_set", NULL);
  RNA_def_property_ui_range(prop, -2000.f, 2000.f, 1, 2);
  ...
  RNA_def_property_float_funcs(
      prop, "rna_ConstraintActuator_fhheight_get", "rna_ConstraintActuator_fhheight_set", NULL);
  ...
  RNA_def_property_float_funcs(
      prop, "rna_ConstraintActuator_spring_get", "rna_ConstraintActuator_spring_set", NULL);
...
static void rna_def_edit_object_actuator(BlenderRNA *brna)
{
  ...
  RNA_def_property_boolean_sdna(
      prop, NULL, "dyn_operation_flag", ACT_EDOB_SUSPEND_PHY_FREE_CONSTRAINTS);
  ...
  RNA_def_property_boolean_sdna(
      prop, NULL, "dyn_operation_flag", ACT_EDOB_RESTORE_PHY_CHILDREN_RECURSIVE);
