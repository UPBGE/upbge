...
void RNA_def_camera(BlenderRNA *brna)
{
	...
	/* flag */
	prop = RNA_def_property(srna, "show_camera_frustum", PROP_BOOLEAN, PROP_NONE);
	RNA_def_property_boolean_sdna(prop, NULL, "flag", CAM_SHOW_GE_FRUSTUM);
	RNA_def_property_ui_text(prop, "Show Camera Frustum", "Show a visualization of Camera Frustum in Game Engine");
