...
const CustomData_MeshMasks CD_MASK_MESH = {
    ...
    /*fmask*/ 0,
    /*pmask*/
    CD_MASK_PROP_ALL | CD_MASK_RECAST,
    /*lmask*/
...
const CustomData_MeshMasks CD_MASK_DERIVEDMESH = {
    ...
    /*pmask*/
    (CD_MASK_ORIGINDEX | CD_MASK_PROP_ALL | CD_MASK_RECAST),
    /*lmask*/
...
const CustomData_MeshMasks CD_MASK_EVERYTHING = {
    ...
    /*pmask*/
    (CD_MASK_BM_ELEM_PYPTR | CD_MASK_RECAST | CD_MASK_ORIGINDEX | CD_MASK_PROP_ALL),
    /*lmask*/
