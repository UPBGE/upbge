...
PyObject *BL_ArmatureActuator::pyattr_get_object(PyObjectPlus *self,
...
int BL_ArmatureActuator::pyattr_set_object(PyObjectPlus *self,
                                           const struct KX_PYATTRIBUTE_DEF *attrdef,
                                           PyObject *value)
{
  BL_ArmatureActuator *actuator = static_cast<BL_ArmatureActuator *>(self);
...
PyObject *BL_ArmatureActuator::pyattr_get_constraint(PyObjectPlus *self,
                                                     const struct KX_PYATTRIBUTE_DEF *attrdef)
{
  BL_ArmatureActuator *actuator = static_cast<BL_ArmatureActuator *>(self);
