...
PyTypeObject BL_ArmatureActuator::Type = {PyVarObject_HEAD_INIT(nullptr, 0) "BL_ArmatureActuator",
...
PyAttributeDef BL_ArmatureActuator::Attributes[] = {
    EXP_PYATTRIBUTE_RO_FUNCTION("constraint", BL_ArmatureActuator, pyattr_get_constraint),
    EXP_PYATTRIBUTE_RW_FUNCTION(
        "target", BL_ArmatureActuator, pyattr_get_object, pyattr_set_object),
    EXP_PYATTRIBUTE_RW_FUNCTION(
        "subtarget", BL_ArmatureActuator, pyattr_get_object, pyattr_set_object),
    EXP_PYATTRIBUTE_FLOAT_RW("weight", 0.0f, 1.0f, BL_ArmatureActuator, m_weight),
    EXP_PYATTRIBUTE_FLOAT_RW("influence", 0.0f, 1.0f, BL_ArmatureActuator, m_influence),
    EXP_PYATTRIBUTE_INT_RW("type", 0, ACT_ARM_MAXTYPE, false, BL_ArmatureActuator, m_type),
    EXP_PYATTRIBUTE_NULL  // Sentinel
};

PyObject *BL_ArmatureActuator::pyattr_get_object(EXP_PyObjectPlus *self,
                                                 const struct EXP_PYATTRIBUTE_DEF *attrdef)
{
  BL_ArmatureActuator *actuator = static_cast<BL_ArmatureActuator *>(self);
  KX_GameObject *target = (attrdef->m_name == "target") ? actuator->m_gametarget :
                                                          actuator->m_gamesubtarget;
  if (!target)
    Py_RETURN_NONE;
  else
...
int BL_ArmatureActuator::pyattr_set_object(EXP_PyObjectPlus *self,
                                           const struct EXP_PYATTRIBUTE_DEF *attrdef,
                                           PyObject *value)
{
  BL_ArmatureActuator *actuator = static_cast<BL_ArmatureActuator *>(self);
  ...
  if (!ConvertPythonToGameObject(actuator->GetLogicManager(),
                                 ...
                                 &gameobj,
                                 true,
                                 "actuator.object = value: BL_ArmatureActuator"))
...
PyObject *BL_ArmatureActuator::pyattr_get_constraint(EXP_PyObjectPlus *self,
                                                     const struct EXP_PYATTRIBUTE_DEF *attrdef)
{
  BL_ArmatureActuator *actuator = static_cast<BL_ArmatureActuator *>(self);
