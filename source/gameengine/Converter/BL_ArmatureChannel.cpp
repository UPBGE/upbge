...
PyAttributeDef BL_ArmatureChannel::AttributesPtr[] = {
    ...
    KX_PYATTRIBUTE_RW_FUNCTION("joint_rotation",
                               BL_ArmatureChannel,
...
PyObject *BL_ArmatureChannel::py_attr_getattr(PyObjectPlus *self_v,
...
int BL_ArmatureChannel::py_attr_setattr(PyObjectPlus *self_v,
                                        const struct KX_PYATTRIBUTE_DEF *attrdef,
                                        PyObject *value)
{
  BL_ArmatureChannel *self = static_cast<BL_ArmatureChannel *>(self_v);
...
PyObject *BL_ArmatureChannel::py_attr_get_joint_rotation(PyObjectPlus *self_v,
                                                         const struct KX_PYATTRIBUTE_DEF *attrdef)
{
  BL_ArmatureChannel *self = static_cast<BL_ArmatureChannel *>(self_v);
...
int BL_ArmatureChannel::py_attr_set_joint_rotation(PyObjectPlus *self_v,
                                                   const struct KX_PYATTRIBUTE_DEF *attrdef,
                                                   PyObject *value)
{
  BL_ArmatureChannel *self = static_cast<BL_ArmatureChannel *>(self_v);
...
PyObject *BL_ArmatureBone::py_bone_get_parent(PyObjectPlus *self,
                                              const struct KX_PYATTRIBUTE_DEF *attrdef)
{
...
PyObject *BL_ArmatureBone::py_bone_get_children(PyObjectPlus *self,
                                                const struct KX_PYATTRIBUTE_DEF *attrdef)
{
  Bone *bone = reinterpret_cast<Bone *>(self);
  Bone *child;
