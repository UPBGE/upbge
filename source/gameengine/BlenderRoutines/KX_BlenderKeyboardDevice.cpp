...
bool KX_BlenderKeyboardDevice::IsPressed(SCA_IInputDevice::SCA_EnumInputs inputcode)
{
...
/*const SCA_InputEvent&	KX_BlenderKeyboardDevice::GetEvent(SCA_IInputDevice::SCA_EnumInputs inputcode)
{
