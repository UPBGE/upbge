...
class KX_GameObject : public SCA_IObject {
 ...
 public:
  ...
  void TagForUpdate(bool is_overlay_pass, bool sceneExit);
  ...
  //
  // * there should NEVER be a CValue and a m_attr_dict attribute with matching names. get/sets
  // make sure of this.
  // * if CValue conversion fails, use a PyObject in "m_attr_dict"
  // * when assigning a value, first see if it can be a CValue, if it can remove the "m_attr_dict"
  // and set the CValue
  //
  ...
  static int pyattr_set_name(PyObjectPlus *self_v,
                             const KX_PYATTRIBUTE_DEF *attrdef,
                             PyObject *value);
  static PyObject *pyattr_get_parent(PyObjectPlus *self_v, const KX_PYATTRIBUTE_DEF *attrdef);

  static PyObject *pyattr_get_group_object(PyObjectPlus *self_v,
                                           const KX_PYATTRIBUTE_DEF *attrdef);
  static PyObject *pyattr_get_group_members(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef);
  ...
  static int pyattr_set_visible(PyObjectPlus *self_v,
                                const KX_PYATTRIBUTE_DEF *attrdef,
                                PyObject *value);
  static PyObject *pyattr_get_worldPosition(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_worldPosition(PyObjectPlus *self_v,
                                      const KX_PYATTRIBUTE_DEF *attrdef,
                                      PyObject *value);
  static PyObject *pyattr_get_localPosition(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_localPosition(PyObjectPlus *self_v,
                                      const KX_PYATTRIBUTE_DEF *attrdef,
                                      PyObject *value);
  static PyObject *pyattr_get_localInertia(PyObjectPlus *self_v,
                                           const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_localInertia(PyObjectPlus *self_v,
                                     const KX_PYATTRIBUTE_DEF *attrdef,
                                     PyObject *value);
  static PyObject *pyattr_get_worldOrientation(PyObjectPlus *self_v,
                                               const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_worldOrientation(PyObjectPlus *self_v,
                                         const KX_PYATTRIBUTE_DEF *attrdef,
                                         PyObject *value);
  static PyObject *pyattr_get_localOrientation(PyObjectPlus *self_v,
                                               const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_localOrientation(PyObjectPlus *self_v,
                                         const KX_PYATTRIBUTE_DEF *attrdef,
                                         PyObject *value);
  static PyObject *pyattr_get_worldScaling(PyObjectPlus *self_v,
                                           const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_worldScaling(PyObjectPlus *self_v,
                                     const KX_PYATTRIBUTE_DEF *attrdef,
                                     PyObject *value);
  static PyObject *pyattr_get_localScaling(PyObjectPlus *self_v,
                                           const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_localScaling(PyObjectPlus *self_v,
                                     const KX_PYATTRIBUTE_DEF *attrdef,
                                     PyObject *value);
  static PyObject *pyattr_get_localTransform(PyObjectPlus *self_v,
                                             const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_localTransform(PyObjectPlus *self_v,
                                       const KX_PYATTRIBUTE_DEF *attrdef,
                                       PyObject *value);
  static PyObject *pyattr_get_worldTransform(PyObjectPlus *self_v,
                                             const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_worldTransform(PyObjectPlus *self_v,
                                       const KX_PYATTRIBUTE_DEF *attrdef,
                                       PyObject *value);
  static PyObject *pyattr_get_worldLinearVelocity(PyObjectPlus *self_v,
                                                  const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_worldLinearVelocity(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef,
                                            PyObject *value);
  static PyObject *pyattr_get_localLinearVelocity(PyObjectPlus *self_v,
                                                  const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_localLinearVelocity(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef,
                                            PyObject *value);
  static PyObject *pyattr_get_worldAngularVelocity(PyObjectPlus *self_v,
                                                   const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_worldAngularVelocity(PyObjectPlus *self_v,
                                             const KX_PYATTRIBUTE_DEF *attrdef,
                                             PyObject *value);
  static PyObject *pyattr_get_localAngularVelocity(PyObjectPlus *self_v,
                                                   const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_localAngularVelocity(PyObjectPlus *self_v,
                                             const KX_PYATTRIBUTE_DEF *attrdef,
                                             PyObject *value);
  ...
  static int pyattr_set_timeOffset(PyObjectPlus *self_v,
                                   const KX_PYATTRIBUTE_DEF *attrdef,
                                   PyObject *value);
  static PyObject *pyattr_get_state(PyObjectPlus *self_v, const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_state(PyObjectPlus *self_v,
                              const KX_PYATTRIBUTE_DEF *attrdef,
                              PyObject *value);
  ...
  static PyObject *pyattr_get_children_recursive(PyObjectPlus *self_v,
                                                 const KX_PYATTRIBUTE_DEF *attrdef);
  ...
  static int pyattr_set_obcolor(PyObjectPlus *self_v,
                                const KX_PYATTRIBUTE_DEF *attrdef,
                                PyObject *value);
  static PyObject *pyattr_get_components(PyObjectPlus *selv_v, const KX_PYATTRIBUTE_DEF *attrdef);
  static PyObject *pyattr_get_collisionCallbacks(PyObjectPlus *self_v,
                                                 const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_collisionCallbacks(PyObjectPlus *self_v,
                                           const KX_PYATTRIBUTE_DEF *attrdef,
                                           PyObject *value);
  static PyObject *pyattr_get_collisionGroup(PyObjectPlus *self_v,
                                             const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_collisionGroup(PyObjectPlus *self_v,
                                       const KX_PYATTRIBUTE_DEF *attrdef,
                                       PyObject *value);
  static PyObject *pyattr_get_collisionMask(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_collisionMask(PyObjectPlus *self_v,
                                      const KX_PYATTRIBUTE_DEF *attrdef,
                                      PyObject *value);
  static PyObject *pyattr_get_debug(PyObjectPlus *self_v, const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_debug(PyObjectPlus *self_v,
                              const KX_PYATTRIBUTE_DEF *attrdef,
                              PyObject *value);
  static PyObject *pyattr_get_debugRecursive(PyObjectPlus *self_v,
                                             const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_debugRecursive(PyObjectPlus *self_v,
                                       const KX_PYATTRIBUTE_DEF *attrdef,
                                       PyObject *value);
  static PyObject *pyattr_get_linearDamping(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_linearDamping(PyObjectPlus *self_v,
                                      const KX_PYATTRIBUTE_DEF *attrdef,
                                      PyObject *value);
  static PyObject *pyattr_get_angularDamping(PyObjectPlus *self_v,
                                             const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_angularDamping(PyObjectPlus *self_v,
                                       const KX_PYATTRIBUTE_DEF *attrdef,
                                       PyObject *value);
  static PyObject *pyattr_get_lodManager(PyObjectPlus *self_v, const KX_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_lodManager(PyObjectPlus *self_v,
                                   const KX_PYATTRIBUTE_DEF *attrdef,
                                   PyObject *value);
