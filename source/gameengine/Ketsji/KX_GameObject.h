...
class KX_GameObject : public SCA_IObject {
 ...
 public:
  ...
  // * when assigning a value, first see if it can be a EXP_Value, if it can remove the "m_attr_dict"
  // and set the EXP_Value
  //
  ...
  static int pyattr_set_obcolor(EXP_PyObjectPlus *self_v,
                                const EXP_PYATTRIBUTE_DEF *attrdef,
                                PyObject *value);
  static PyObject *pyattr_get_components(EXP_PyObjectPlus *selv_v, const EXP_PYATTRIBUTE_DEF *attrdef);
