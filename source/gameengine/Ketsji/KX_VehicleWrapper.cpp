...
PyObject *KX_VehicleWrapper::pyattr_get_constraintId(PyObjectPlus *self_v,
...
PyObject *KX_VehicleWrapper::pyattr_get_constraintType(PyObjectPlus *self_v,
                                                       const KX_PYATTRIBUTE_DEF *attrdef)
{
  return PyLong_FromLong(PHY_VEHICLE_CONSTRAINT);
}

PyObject *KX_VehicleWrapper::pyattr_get_ray_mask(PyObjectPlus *self,
...
int KX_VehicleWrapper::pyattr_set_ray_mask(PyObjectPlus *self,
                                           const struct KX_PYATTRIBUTE_DEF *attrdef,
                                           PyObject *value)
{
  KX_VehicleWrapper *wrapper = static_cast<KX_VehicleWrapper *>(self);
