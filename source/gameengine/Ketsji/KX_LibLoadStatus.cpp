...
class BL_BlenderConverter *KX_LibLoadStatus::GetConverter()
{
  return m_converter;
}
...
PyAttributeDef KX_LibLoadStatus::Attributes[] = {
    ...
    // KX_PYATTRIBUTE_RW_FUNCTION("onProgress", KX_LibLoadStatus, pyattr_get_onprogress,
...
PyObject *KX_LibLoadStatus::pyattr_get_onfinish(PyObjectPlus *self_v,
...
int KX_LibLoadStatus::pyattr_set_onfinish(PyObjectPlus *self_v,
                                          const KX_PYATTRIBUTE_DEF *attrdef,
                                          PyObject *value)
{
  KX_LibLoadStatus *self = static_cast<KX_LibLoadStatus *>(self_v);
...
PyObject *KX_LibLoadStatus::pyattr_get_onprogress(PyObjectPlus *self_v,
                                                  const KX_PYATTRIBUTE_DEF *attrdef)
{
  KX_LibLoadStatus *self = static_cast<KX_LibLoadStatus *>(self_v);
...
int KX_LibLoadStatus::pyattr_set_onprogress(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef,
                                            PyObject *value)
{
  KX_LibLoadStatus *self = static_cast<KX_LibLoadStatus *>(self_v);
...
PyObject *KX_LibLoadStatus::pyattr_get_timetaken(PyObjectPlus *self_v,
                                                 const KX_PYATTRIBUTE_DEF *attrdef)
{
  KX_LibLoadStatus *self = static_cast<KX_LibLoadStatus *>(self_v);
