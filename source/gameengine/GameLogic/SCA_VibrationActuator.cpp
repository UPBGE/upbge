...
KX_PYMETHODDEF_DOC_NOARGS(SCA_VibrationActuator,
                          startVibration,
                          "startVibration()\n"
...
PyObject *SCA_VibrationActuator::pyattr_get_isVibrating(PyObjectPlus *self_v,
...
PyObject *SCA_VibrationActuator::pyattr_get_hasVibration(PyObjectPlus *self_v,
                                                         const struct KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_VibrationActuator *self = static_cast<SCA_VibrationActuator *>(self_v);
  SCA_JoystickManager *mgr = (SCA_JoystickManager *)self->GetLogicManager();
