...
PyObject *SCA_PythonController::pyattr_get_script(PyObjectPlus *self_v,
                                                  const KX_PYATTRIBUTE_DEF *attrdef)
{
  // SCA_PythonController* self =
  // static_cast<SCA_PythonController*>(static_cast<SCA_IController*>(static_cast<SCA_ILogicBrick*>(static_cast<CValue*>(static_cast<PyObjectPlus*>(self_v)))));
...
int SCA_PythonController::pyattr_set_script(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef,
                                            PyObject *value)
{
  SCA_PythonController *self = static_cast<SCA_PythonController *>(self_v);
