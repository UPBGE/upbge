...
/* modify it under the terms of the GNU blender::Library General Public     */
...
/* See the GNU blender::Library General Public License for more details.    */
/* You should have received a copy of the GNU blender::Library General      */
