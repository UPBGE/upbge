...
PyMethodDef SCA_KeyboardSensor::Methods[] = {
    KX_PYMETHODTABLE_O(SCA_KeyboardSensor, getKeyStatus), {nullptr, nullptr}  // Sentinel
};
...
PyObject *SCA_KeyboardSensor::pyattr_get_inputs(PyObjectPlus *self_v,
...
PyObject *SCA_KeyboardSensor::pyattr_get_events(PyObjectPlus *self_v,
                                                const KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_KeyboardSensor *self = static_cast<SCA_KeyboardSensor *>(self_v);
