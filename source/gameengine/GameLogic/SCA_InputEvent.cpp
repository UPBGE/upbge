...
PyObject *SCA_InputEvent::pyattr_get_status(PyObjectPlus *self_v,
...
PyObject *SCA_InputEvent::pyattr_get_values(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef)
{
  return (new CListWrapper(self_v,
                           ((SCA_InputEvent *)self_v)->GetProxy(),
...
PyObject *SCA_InputEvent::pyattr_get_inactive(PyObjectPlus *self_v,
                                              const KX_PYATTRIBUTE_DEF *attrdef)
{
...
PyObject *SCA_InputEvent::pyattr_get_active(PyObjectPlus *self_v,
                                            const KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_InputEvent *self = static_cast<SCA_InputEvent *>(self_v);
...
PyObject *SCA_InputEvent::pyattr_get_activated(PyObjectPlus *self_v,
                                               const KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_InputEvent *self = static_cast<SCA_InputEvent *>(self_v);
...
PyObject *SCA_InputEvent::pyattr_get_released(PyObjectPlus *self_v,
                                              const KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_InputEvent *self = static_cast<SCA_InputEvent *>(self_v);
