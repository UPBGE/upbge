...
PyObject *SCA_IController::pyattr_get_state(PyObjectPlus *self_v,
...
PyObject *SCA_IController::pyattr_get_sensors(PyObjectPlus *self_v,
                                              const KX_PYATTRIBUTE_DEF *attrdef)
{
...
PyObject *SCA_IController::pyattr_get_actuators(PyObjectPlus *self_v,
                                                const KX_PYATTRIBUTE_DEF *attrdef)
{
  return (new CListWrapper(self_v,
                           ((SCA_IController *)self_v)->GetProxy(),
