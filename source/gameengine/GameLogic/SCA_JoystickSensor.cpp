...
PyObject *SCA_JoystickSensor::pyattr_get_axis_values(PyObjectPlus *self_v,
...
PyObject *SCA_JoystickSensor::pyattr_get_axis_single(PyObjectPlus *self_v,
                                                     const KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_JoystickSensor *self = static_cast<SCA_JoystickSensor *>(self_v);
  DEV_Joystick *joy =
...
PyObject *SCA_JoystickSensor::pyattr_check_hat(PyObjectPlus *self_v,
                                               const KX_PYATTRIBUTE_DEF *attrdef)
{
...
PyObject *SCA_JoystickSensor::pyattr_get_hat_values(PyObjectPlus *self_v,
                                                    const KX_PYATTRIBUTE_DEF *attrdef)
{
  ShowDeprecationWarning("SCA_JoystickSensor.hat", "SCA_JoystickSensor.button");
  return nullptr;
...
PyObject *SCA_JoystickSensor::pyattr_get_hat_single(PyObjectPlus *self_v,
                                                    const KX_PYATTRIBUTE_DEF *attrdef)
{
...
PyObject *SCA_JoystickSensor::pyattr_get_num_axis(PyObjectPlus *self_v,
                                                  const KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_JoystickSensor *self = static_cast<SCA_JoystickSensor *>(self_v);
  DEV_Joystick *joy =
...
PyObject *SCA_JoystickSensor::pyattr_get_num_buttons(PyObjectPlus *self_v,
                                                     const KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_JoystickSensor *self = static_cast<SCA_JoystickSensor *>(self_v);
  DEV_Joystick *joy =
...
PyObject *SCA_JoystickSensor::pyattr_get_num_hats(PyObjectPlus *self_v,
                                                  const KX_PYATTRIBUTE_DEF *attrdef)
{
...
PyObject *SCA_JoystickSensor::pyattr_get_connected(PyObjectPlus *self_v,
                                                   const KX_PYATTRIBUTE_DEF *attrdef)
{
  SCA_JoystickSensor *self = static_cast<SCA_JoystickSensor *>(self_v);
  DEV_Joystick *joy =
