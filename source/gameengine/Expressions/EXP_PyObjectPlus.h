...
#  define EXP_ShowDeprecationWarning(old_way, new_way) \
    { \
      ...
      if ((EXP_PyObjectPlus::GetDeprecationWarnings() || wlink.warn_done) == 0) { \
    ...
    { \
      if (EXP_PROXY_REF(self) == nullptr) { \
        PyErr_SetString(PyExc_RuntimeError, \
                        #class_name "." #method_name "() - " EXP_PROXY_ERROR_MSG); \
        return nullptr; \
      } \
...
#  define EXP_PYMETHOD_O(class_name, method_name) \
    ...
    { \
      if (EXP_PROXY_REF(self) == nullptr) { \
        PyErr_SetString(PyExc_RuntimeError, \
                        #class_name "." #method_name "(value) - " EXP_PROXY_ERROR_MSG); \
        return nullptr; \
      } \
...
enum EXP_PYATTRIBUTE_ACCESS { EXP_PYATTRIBUTE_RW, EXP_PYATTRIBUTE_RO };
...
#  define EXP_PYATTRIBUTE_NULL \
    { \
      "", EXP_PYATTRIBUTE_TYPE_BOOL, EXP_PYATTRIBUTE_RW, 0, 1, 0.f, 0.f, false, false, 0, 0, 1, \
...
#  define EXP_PYATTRIBUTE_BOOL_RW(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_BOOL, EXP_PYATTRIBUTE_RW, 0, 1, 0.f, 0.f, false, false, \
...
#  define EXP_PYATTRIBUTE_BOOL_RO(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_BOOL, EXP_PYATTRIBUTE_RO, 0, 1, 0.f, 0.f, false, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
        &((object *)0)->field, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_FLAG_RW(name, object, field, bit) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_FLAG, EXP_PYATTRIBUTE_RW, bit, 0, 0.f, 0.f, false, false, \
...
#  define EXP_PYATTRIBUTE_FLAG_RO(name, object, field, bit) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_FLAG, EXP_PYATTRIBUTE_RO, bit, 0, 0.f, 0.f, false, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_FLAG_NEGATIVE_RW(name, object, field, bit) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_FLAG, EXP_PYATTRIBUTE_RW, bit, 1, 0.f, 0.f, false, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_FLAG_NEGATIVE_RO(name, object, field, bit) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_FLAG, EXP_PYATTRIBUTE_RO, bit, 1, 0.f, 0.f, false, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_ENUM_RW(name, min, max, clamp, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_ENUM, EXP_PYATTRIBUTE_RW, min, max, 0.f, 0.f, clamp, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_ENUM_RO(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_ENUM, EXP_PYATTRIBUTE_RO, 0, 0, 0.f, 0.f, false, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_SHORT_RW(name, min, max, clamp, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_SHORT, EXP_PYATTRIBUTE_RW, min, max, 0.f, 0.f, clamp, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
...
#  define EXP_PYATTRIBUTE_SHORT_RO(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_SHORT, EXP_PYATTRIBUTE_RO, 0, 0, 0.f, 0.f, false, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, &((object *)0)->field, nullptr, nullptr, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_SHORT_ARRAY_RW_CHECK( \
...
#  define EXP_PYATTRIBUTE_SHORT_LIST_RWW(name, min, max, clamp, object, field, length) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_SHORT, EXP_PYATTRIBUTE_RW, min, max, 0.f, 0.f, clamp, false, \
          offsetof(object, field), 0, length, nullptr, nullptr, nullptr, \
      { \
...
#  define EXP_PYATTRIBUTE_SHORT_LIST_RW_CHECK( \
      name, min, max, clamp, object, field, length, function) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_SHORT, EXP_PYATTRIBUTE_RW, min, max, 0.f, 0.f, clamp, false, \
          offsetof(object, field), 0, length, &object::function, nullptr, nullptr, \
...
#  define EXP_PYATTRIBUTE_INT_RW(name, min, max, clamp, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_INT, EXP_PYATTRIBUTE_RW, min, max, 0.f, 0.f, clamp, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
...
#  define EXP_PYATTRIBUTE_INT_RO(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_INT, EXP_PYATTRIBUTE_RO, 0, 0, 0.f, 0.f, false, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, &((object *)0)->field, nullptr, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_INT_ARRAY_RW_CHECK( \
      name, min, max, clamp, object, field, length, function) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_INT, EXP_PYATTRIBUTE_RW, min, max, 0.f, 0.f, clamp, false, \
          offsetof(object, field), 0, length, &object::function, nullptr, nullptr, \
...
#  define EXP_PYATTRIBUTE_INT_LIST_RW_CHECK( \
      name, min, max, clamp, object, field, length, function) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_INT, EXP_PYATTRIBUTE_RW, min, max, 0.f, 0.f, clamp, false, \
          offsetof(object, field), 0, length, &object::function, nullptr, nullptr, \
...
#  define EXP_PYATTRIBUTE_FLOAT_RW(name, min, max, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_FLOAT, EXP_PYATTRIBUTE_RW, 0, 0, min, max, true, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
...
#  define EXP_PYATTRIBUTE_FLOAT_RO(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_FLOAT, EXP_PYATTRIBUTE_RO, 0, 0, 0.f, 0.f, false, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, &((object *)0)->field, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_FLOAT_VECTOR_RW(name, min, max, object, field, length) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_FLOAT, EXP_PYATTRIBUTE_RW, 0, length, min, max, true, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, ((object *)0)->field, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_FLOAT_VECTOR_RO(name, object, field, length) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_FLOAT, EXP_PYATTRIBUTE_RO, 0, length, 0.f, 0.f, false, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, ((object *)0)->field, nullptr, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_STRING_RW(name, min, max, clamp, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_STRING, EXP_PYATTRIBUTE_RW, min, max, 0.f, 0.f, clamp, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
...
#  define EXP_PYATTRIBUTE_STRING_RO(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_STRING, EXP_PYATTRIBUTE_RO, 0, 0, 0.f, 0.f, false, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, nullptr, &((object *)0)->field, nullptr, nullptr \
      } \
...
#  define EXP_PYATTRIBUTE_CHAR_RW(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_CHAR, EXP_PYATTRIBUTE_RW, 0, 0, 0.f, 0.f, true, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
...
#  define EXP_PYATTRIBUTE_CHAR_RO(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_CHAR, EXP_PYATTRIBUTE_RO, 0, 0, 0.f, 0.f, false, false, \
          offsetof(object, field), sizeof(((object *)0)->field), 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, ((object *)0)->field \
      } \
...
#  define EXP_PYATTRIBUTE_VECTOR_RW(name, min, max, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_VECTOR, EXP_PYATTRIBUTE_RW, 0, 0, min, max, true, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
...
#  define EXP_PYATTRIBUTE_VECTOR_RO(name, object, field) \
    { \
      name, EXP_PYATTRIBUTE_TYPE_VECTOR, EXP_PYATTRIBUTE_RO, 0, 0, 0.f, 0.f, false, false, \
          offsetof(object, field), 0, 1, nullptr, nullptr, nullptr, \
      { \
        nullptr, nullptr, nullptr, nullptr, nullptr, &((object *)0)->field, nullptr \
      } \
...
class EXP_PyObjectPlus {
 ...
 public:
  ...
  static bool GetDeprecationWarnings();
